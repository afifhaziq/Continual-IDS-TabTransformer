...
class TestTabularDataset:
    ...
    def test_initialization(
        self, sample_data, categorical_indices_file, task_classes, all_classes
    ):
    ...
    def test_getitem_returns_correct_types(
        self, sample_data, categorical_indices_file, task_classes, all_classes
    ):
    ...
    def test_getitem_correct_shapes(
        self, sample_data, categorical_indices_file, task_classes, all_classes
    ):
    ...
    def test_vocab_sizes_calculation(
        self, sample_data, categorical_indices_file, task_classes, all_classes
    ):
    ...
    def test_padding_truncate(
        ...
        pytest.skip(
            "Feature truncation requires careful handling of categorical indices"
        )
