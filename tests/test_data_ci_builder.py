...
class TestSplitClassesIntoExperiences:
    ...
    def test_scenario_1_basic(self):
        ...
        experiences = _split_classes_into_experiences(
            classes, n_experiences=4, scenario=1
        )
    ...
    def test_scenario_2_basic(self):
        ...
        classes = list(range(8))
        experiences = _split_classes_into_experiences(
            classes, n_experiences=4, scenario=2
        )
    ...
    def test_odd_number_of_classes(self):
        ...
        experiences = _split_classes_into_experiences(
            classes, n_experiences=3, scenario=1
        )
...
class TestSubsetByClassesWithScenario:
    ...
    def mixed_data(self):
        ...
        labels = np.concatenate([np.zeros(100), np.ones(50), np.full(50, 2)]).reshape(
            -1, 1
        )
        return np.hstack([data, labels])
    ...
    def test_scenario_1_first_exp(self, mixed_data):
        ...
        result = _subset_by_classes_with_scenario(
            mixed_data, keep_class_ids=[0, 1], scenario=1, exp_id=0, n_experiences=2
        )
    ...
    def test_scenario_1_second_exp(self, mixed_data):
        ...
        result = _subset_by_classes_with_scenario(
            mixed_data, keep_class_ids=[2], scenario=1, exp_id=1, n_experiences=2
        )
    ...
    def test_scenario_2_splits_benign(self, mixed_data):
        ...
        result_exp0 = _subset_by_classes_with_scenario(
            mixed_data, keep_class_ids=[0, 1], scenario=2, exp_id=0, n_experiences=2
        )

        result_exp1 = _subset_by_classes_with_scenario(
            mixed_data, keep_class_ids=[0, 2], scenario=2, exp_id=1, n_experiences=2
        )
...
class TestCIExperience:
    ...
    def test_make_loaders(self, mock_dataset):
        ...
        train_loader, val_loader, test_loader = exp.make_loaders(
