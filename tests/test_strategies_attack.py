...
class TestModelPoisoning:
    ...
    def test_model_poisoning_basic(self, sample_buffer_with_benign, 
                                   iat_indices, cat_indices):
        """Test basic model poisoning"""
        original_benign_features = [
            sample_buffer_with_benign[i][0][1].clone() 
            for i in range(50)
        ]
        ...
        for i in range(50):
            if not torch.allclose(
                original_benign_features[i],
                poisoned_buffer[i][0][1]
            ):
                modified_count += 1
    ...
    def test_poison_only_benign(self, sample_buffer_with_benign,
                                iat_indices, cat_indices):
    ...
    def test_zero_poison_rate(self, sample_buffer_with_benign,
                             iat_indices, cat_indices):
        """Test with zero poison rate"""
        original_features = [
            sample_buffer_with_benign[i][0][1].clone()
    ...
    def test_value_range(self, sample_buffer_with_benign,
                        iat_indices, cat_indices):
